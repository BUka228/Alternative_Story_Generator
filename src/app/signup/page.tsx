...
// Иконка Google (та же самая, что и в signin)
const GoogleIcon = () => (
...
export default function SignUpPage() {
  ...
  // Обработчик регистрации через Email/Password (без изменений)
  ...
  // --- НОВЫЙ ОБРАБОТЧИК для Google Sign-In (Идентичен тому, что на странице входа) ---
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required minLength={6} disabled={loading || googleLoading}
                 className="rounded-md shadow-sm focus:border-a020f0 focus:ring-a020f0"
              />
            </div>
            <div className="space-y-2">
